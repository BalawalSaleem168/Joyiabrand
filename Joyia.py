#Script Given By Balawal Saleem 
...
\n\033[0m----------------------------------
\033[1;92mAuthor \033[1;93m: Balawal Saleem 
\033[1;92mFb \033[1;93m: Balawal 
...
def crack_select():
    ...
    print '   \x1b[0m Total Ok / Cp ids : ' + str(len(oks)) + '/' + str(len(cps)) ##Thanks Balawal & Also Saleem 
    print 45 * '\033[0m_\033[0m'
    print ''
    print ''
